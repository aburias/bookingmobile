                ...
                if (businessHour.Day == bookingDay) {
                    {
                        $.each(businessHour.Intervals, function (iIndex, interval) {
                            ...
                            if ($(".booking-interval a[id='" + interval + "']").length <= 0) {
                                if (available) {
                                    $("#booking-time-container").append("<div class='booking-interval'><a id='" + interval + "' class='available' href='#'>" + interval + "</a></div>");
                                } else {
                                    $("#booking-time-container").append("<div class='booking-interval'><a id='" + interval + "' class='unavailable' href='#'>" + interval + "</a></div>");
                                }
                            }
