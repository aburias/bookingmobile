...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                ...
                lang: 'en',
                am_pm: true,
                weatherLocationCode: 'NAM|CA|ON|TORONTO',
                weatherMetric: 'C',
                weatherUpdate: 10,
                proxyType: 'php'
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON('/js/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="/images/clock/refresh_01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
